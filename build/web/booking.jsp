<%-- 
    Document   : booking
    Created on : Jul 7, 2023, 7:35:43 AM
    Author     : likir
--%>
...
<html>
    ...
    <body>
        <%
            ...
            System.out.println(rno + desc + price + status);
        %>
        ...
        <div>
            <div class="head">
                <table>
                    <tr><td><h3>Room booking</h3></td></tr>
                </table>
            </div>           
        </div>
        <%

                rst = stmt.executeQuery("select * from roomdetails where roomno='" + rno + "'");
                if (rst.next()) {
            %>
        <div class="donation">
            <div class="container">
                <h1>Room booking</h1>
                <form action="bookingcheck.jsp" method="POST">
                    <div class="form-group">
                        <label for="mobile">Room No:</label>
                        <input type="text" id="roomno" name="roomno" value="<%=rst.getString(1)%>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="amount">Price:</label>
                        <input type="text" id="prize" name="price" value="<%=rst.getString(3)%>"  readonly>
                    </div>
                    <%
                        String email = (String) session.getAttribute("username");
                        rst = stmt.executeQuery("select * from signup where email ='" + email + "'");
                        if (rst.next()) {
                    %>
                    <div class="form-group">
                        <label for="amount">Name:</label>
                        <input type="text" id="name" name="name" value="<%=rst.getString("name")%>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="amount">Email:</label>
                        <input type="text" id="email" name="email" value="<%=rst.getString("email")%>"  readonly>
                    </div>

                    <div class="form-group">
                        <label for="mobile">Mobile Number:</label>
                        <input type="text" id="mobile" name="mobile" value="<%=rst.getString("mobile")%>" required>
                    </div>
                    <%
                        }
                    %>
                    <div class="form-group">
                        ...
                        <input type="datetime-local" id="checkin" name="checkinDT" required>
                    </div>
