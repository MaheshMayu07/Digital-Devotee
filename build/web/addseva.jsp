<%-- 
    Document   : addseva
    Created on : Jul 3, 2023, 4:30:42 PM
    Author     : likir
--%>
...
<html>
    ...
    <body>
        ...
        <div>
            <div class="head">
                <table>
                    <tr><td><h3>Add Sevas</h3></td></tr>
                </table>
            </div>           
        </div>
        <div class="addseva">
            <h2><u>Add Seva</u></h2>
            <form action="addsevacheck.jsp" method="post">
                <div class="group">
                    <label for="seva_name">Seva Name:</label>
                    <input type="text" id="seva_name" pattern="[A-Za-z]{1,} { }"   title="Please enter only characters"  name="seva_name" required>
                </div>
                <div class="group">
                    <label for="seva_description">Seva Description:</label>
                    <input type="text" id="seva_description"  name="seva_description" required>
                </div>
                <div class="group">
                    <label for="seva_description">Seva Amount:</label>
                    <input type="number" id="seva_amount" name="seva_amount" required>
                </div>
                <div class="group">
                    <label for="seva_duration">Seva Timings</label>
                    <input type="time" id="seva_duration" name="seva_time" required>
                </div>
                <div class="group">
                    <input type="submit" value="Add Seva">
                </div>
            </form>
        </div>
    </body>
