<%-- 
    Document   : adminhome
    Created on : Jul 1, 2023, 6:31:17 PM
    Author     : likir
--%>
...
<html>
    ...
    <body>
        ...
        <div>
            <div class="head">
                <table>
                    <tr><td><h3>Devotees</h3></td></tr>
                </table>
            </div>           
        </div>
        <div class="design">
            <div class="data">
                <h1><u>List of active Devotes</u></h1>                 
                <table class="tab">                   
                    <tr id="thead"><th>NAME</th> <th>EMAIL</th> <th>DOB</th> <th>MOBILE NO.</th></tr>
                    <%
