<%-- 
    Document   : rooms
    Created on : Jul 16, 2023, 3:35:09 PM
    Author     : likir
--%>
<%-- 
    Document   : sevas
    Created on : Jul 3, 2023, 4:22:09 PM
    Author     : likir
--%>
...
<html>
    ...
    <body>
        ...
        <div>
            <div class="head">
                <table>
                    <tr><td><h3>Manage Rooms</h3></td></tr>
                </table>
            </div>           
        </div>
        <div class="design">
            <div class="data">
                ...
                <table class="tab">                   
                    <tr id="thead"><th>Room No</th> <th>Amount</th> <th>Status</th></tr>
                    <%
                        rst = stmt.executeQuery("select * from roomdetails");
                        while (rst.next()) {
                            out.println("<tr><td>" + rst.getString(1) + "</td>" + "<td>" + rst.getString(3) + "</td>" + "<td>" + rst.getString(4) + "</td></tr>");
                        }
                    %>
                </table>
            </div>
                ...
                <a class="btn" href="editroom.jsp">Edit Room</a>
                <a class="btn" href="deleteroom.jsp">Delete Room</a>
            </div>
                <form action="roomcheckout.jsp" >
                <div class="group">
