<%-- 
    Document   : bookroom
    Created on : Jul 7, 2023, 7:13:51 AM
    Author     : likir
--%>
        ...
        <div>
            ...
            <div class="data">
                <form method="POST" action="booking.jsp">
                    <table class="tab">
                        <tr><th><u><h3>List of Rooms available</h3></u></th></tr>

                        <tr id="th"><th>ROOM NO.</th> <th>ROOM DESCRIPTION</th> <th>PRIZE</th> <th>STATUS</th></tr>
                        <%
                            rst = stmt.executeQuery("select * from roomdetails where status='Available'");
                            while (rst.next()) {
                        %>
                        <tr id="book">
                            ...
                            <td id="a"><a href="booking.jsp?roomno=<%=rst.getString(1)%>">Book</a></td>
                        </tr>
                                <%     }
                                %>
                    </table>                   
