<%-- 
    Document   : getprasadacheck
    Created on : Jul 10, 2023, 2:01:59 PM
    Author     : likir
--%>
...
<html>
    ...
    <body>
        <%  
            ...
            Integer total = Integer.parseInt(rate) * Integer.parseInt(quantity);
            String tamount = total.toString();
            stmt.executeUpdate("insert into dprasadam value('" + name + "','" + email + "','" + prasadamname + "','" + rate + "','" + quantity + "','" + tamount + "','" + orderId + "')");
        ...
        rst = stmt.executeQuery("select * from Dprasadam where orderId='" + orderId + "'");
         ...
         %>
        <div class="container">
            <h1>Prasadam Checkout</h1>
            <form method="post" action="prasadampayment.jsp">
                <div class="form-group">
                    <label for="rate">Name:</label>
                    <input type="text" id="name" value="<%=rst.getString("name")%>" name="name" readonly>
                </div>
                <div class="form-group">
                    <label for="rate">Email</label>
                    <input type="text" id="email" value="<%=rst.getString("email")%>" name="email" readonly>
                </div>
                <div class="form-group">
                    <label for="prasadam-name">Prasadam:</label>
                    <input type="text" value="<%=rst.getString("prasadamname")%>" id="prasadam-name" name="prasadam-name" readonly>
                </div>
                <div class="form-group">
                    <label for="rate">Rate:</label>
                    <input type="text" id="rate" value="<%=rst.getString("rate")%>" name="rate" readonly>
                </div>
                <div class="form-group">
                    <label for="quantity">Quantity:</label>
                    <input type="text" id="quantity" value="<%=rst.getString("quantity")%>" name="quantity"  readonly>
                </div>
                <div class="form-group">
                    <label for="rate">Total amount:</label>
                    <input type="text" id="rate" value="<%=rst.getString("totalamount")%>" name="tamount" readonly>
                </div>
                <input type="hidden" name="orderId" value="<%=rst.getString("orderId")%>">
                <div class="form-group">
