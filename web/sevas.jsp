...
<html>
    ...
    <body>
        ...
        <div>
            <div class="head">
                <table>
                    <tr><td><h3>Manage Sevas</h3></td></tr>
                </table>
            </div>           
        </div>
        <div class="design">
            <div class="data">
                <h1><u>List of Sevas</u></h1>
                <table class="tab">                   
                    <tr id="thead"><th>Seva Name</th> <th>Amount</th> <th>Time</th></tr>
                    <%
                        rst = stmt.executeQuery("select * from sevas");
                        while (rst.next()) {
                ...
                <div id="seva">             
                <a class="btn" href="addseva.jsp">Add Seva</a>
                <a class="btn" href="editseva.jsp">Edit Seva</a>
                <a class="btn" href="deleteseva.jsp">Delete Seva</a>
