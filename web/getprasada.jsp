<%-- 
    Document   : getprasada
    Created on : Jul 8, 2023, 9:45:55 AM
    Author     : likir
--%>
...
<html>
    ...
    <body onload="generateRandomNumber()">
        ...
        %>
        <div class="container"> 
            <h1>Prasadam Purchase</h1>

            <form method="post" action="getprasadacheck.jsp">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="Parimala prasadam" id="prasadam-name" name="prasadam-name" readonly>
                </div>
                <div class="form-group">
                    <label for="rate">Rate:</label>
                    <input type="number" id="rate" value="25" name="rate" readonly>
                </div>
                <div class="form-group">
                    <label for="quantity">Quantity:</label>
                    <input type="number" id="quantity"  name="quantity" placeholder="Enter quantity" required>
                </div>
                <input type="hidden" name="orderId" id="randomNumber">
                <div class="form-group">
