<%-- 
    Document   : deleteroom
    Created on : Jul 16, 2023, 6:08:04 PM
    Author     : likir
--%>
...
<html>
    ...
    <body>
        ...
        <div class="head">
            <table>
                <tr><td><h3>Delete Room</h3></td></tr>
            </table>
        </div>

        <div class="delseva">
            <h2><u>Delete Room</u></h2>
            <form action="deletroomcheck.jsp" method="post">
                <div class="group">
                    <label for="roomno">Select the room number to be deleted:</label>
                    <select name="roomno" id="sel">
                        <%
