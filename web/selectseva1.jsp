<%-- 
    Document   : selectseva1
    Created on : Jul 6, 2023, 7:38:12 AM
    Author     : likir
--%>
...
<html>
    ...
    <body>
       <div class="sidebar">
        ...
        <div class="addseva">
            <h2><u>Seva</u></h2>
            <form action="selectseva.jsp" method="post">

                <div class="group">
                    <label for="seva_name">Select the Type of seva:</label>
                    <select name="seva_name" id="sel">
                        <%

                            rst = stmt.executeQuery("select sevaname from sevas");
                            while (rst.next()) {
                        %>
                        <option>
                            <%=rst.getString(1)%>
