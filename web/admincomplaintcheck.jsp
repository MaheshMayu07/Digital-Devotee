<%-- 
    Document   : admincomplaintcheck
    Created on : Jul 5, 2023, 7:01:26 AM
    Author     : likir
--%>
...
<html>
    ...
    <body>
        ...
        <div>
            <div class="head">
                <table>
                    <tr><td><h3>View Complaints</h3></td></tr>
                </table>
            </div>           
        </div>
        <div class="design">
            <div class="data">
                <h1><u>List of Complaints</u></h1>
                <table class="tab">                  
                    <tr id="thead"><th>NAME</th> <th>EMAIL</th> <th>Complaint description</th> </tr>
                    <%
                        rst = stmt.executeQuery("select * from usercomplaints");
                        while (rst.next()) {
