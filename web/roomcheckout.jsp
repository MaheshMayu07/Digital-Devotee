<%-- 
    Document   : roomcheckout
    Created on : Jul 10, 2023, 6:20:35 PM
    Author     : likir
--%>
...
#book td a{
 ...
 .tab{
    ...
    <body>
        ...
        <div class="design">
            <div class="data">
                <u><h1>List of Rooms Booked</h1></u>
                <form method="POST" action="roomcheckoutcheck1.jsp">
                    <table class="tab">
                        

                        <tr id="th"><th>ROOM NO.</th> <th>ROOM DESCRIPTION</th> <th>PRIZE</th> <th>STATUS</th></tr>
                        <%
                            rst = stmt.executeQuery("select * from roomdetails where status='Booked'");
                            while (rst.next()) {
                        %>
                        <tr id="book">
                            <td><input type="text" name="roomno" readonly value="<%=rst.getString(1)%> "></td> 
                            <td><input type="text" name="description" readonly  value="<%=rst.getString(2)%>"></td>
                            <td><input type="text" readonly name="prize"  value="<%=rst.getString(3)%>"></td>
                            <td><input type="text" name="status" readonly value="<%=rst.getString(4)%>"></td>
                            <td id="a"><a href="roomcheckoutcheck1.jsp?roomno=<%=rst.getString(1)%>">Checkout</a></td>
                        </tr>
                        <%     }
                        %>
                    </table>
