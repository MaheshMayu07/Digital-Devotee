<%-- 
    Document   : donations
    Created on : Jul 3, 2023, 8:46:15 PM
    Author     : likir
--%>
...
<html>
    ...
    <body>
        <%
            int tAmount = 0, pAmount;
            String sAmount;
            rst = stmt.executeQuery("select * from donations");
            while (rst.next()) {
                pAmount = Integer.parseInt(rst.getString(2));
                tAmount = tAmount + pAmount;
            }
        %>
        <div class="sidebar">
            <ul id="sidebar">
        ...
        <div>
            <div class="head">
                <table>
                    <tr><td><h3>Donations</h3></td></tr>
                </table>
            </div>           
        </div>
        <div class="design">
            <div class="data">
                <h1><u>Devotee Donations</u></h1>
                <table class="tab">
                    <tr id="thead"><th>NAME</th> <th>MOBILE NO</th> <th>AMOUNT</th> <th>DATE AND TIME</th></tr>
                    <%
                        rst = stmt.executeQuery("select * from donations");
                        while (rst.next()) {
                            out.println("<tr><td>" + rst.getString(1) + "</td>" + "<td>" + rst.getString(4) + "</td>" + "<td>" + rst.getString(2) + "</td>" + "<td>" + rst.getString(3) + "</td></tr>");
                        }
                    %>
                </table>
            </div>
