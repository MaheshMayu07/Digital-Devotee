<%-- 
    Document   : roomcheckoutcheck1
    Created on : Jul 10, 2023, 6:39:56 PM
    Author     : likir
--%>
...
<html>
    ...
    <body>
        ...
        <div>
            <div class="head">
                <table>
                    <tr><td><h3>Room Checkout</h3></td></tr>
                </table>
            </div>           
        </div>           
            <%

                rst = stmt.executeQuery("select * from currentbookings where roomno='" + rno + "'");
                if (rst.next()) {
            %>
        ...
        <div class="donation">
            <div class="container">
                <h1>Room Checkout</h1>
                <form action="roomcheckoutcheck.jsp" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="prize" name="price" value="<%=rst.getString(2)%>"  readonly>
                    </div>
            
                    <div class="form-group">
                        <label for="amount">Name:</label>
                        <input type="text" id="name" name="name" value="<%=rst.getString(3)%>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="amount">Email:</label>
                        <input type="text" id="email" name="email" value="<%=rst.getString(4)%>"  readonly>
                    </div>

                    <div class="form-group">
                        <label for="mobile">Mobile Number:</label>
                        <input type="text" id="mobile" name="mobile" value="<%=rst.getString(5)%>" required>
                    </div>
                   
                    <div class="form-group">
                        <label for="checkin">Check-in Date and Time:</label>
                        <input type="text" id="checkin" value="<%=rst.getString(6)%>" name="checkinDT" readonly>
                    </div>
