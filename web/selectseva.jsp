<%-- 
    Document   : selectseva
    Created on : Jul 6, 2023, 6:42:02 AM
    Author     : likir
--%>
    ...
    <body>
       <div class="sidebar">
        ...
        <div>
            <div class="head">
                <table>
                    <tr><td><h3>Digital Seva</h3></td></tr>
                </table>
            </div>           
        </div>
            ...
            <div class="addseva">
                <h2><u>Seva</u></h2>
                <form action="selectsevapayment.jsp" method="post">

                    <div class="group">
                        <label for="seva_name">Seva Type:</label>
                        <input type="text" id="seva_name" name="seva_name" value="<%=rst.getString(1)%>" readonly>
                    </div>
                    <div class="group">
                        <label for="seva_description">Seva Description:</label>
                        <input type="text" id="seva_description" name="seva_description" value="<%=rst.getString(2)%>" readonly>
                    </div>
                    <div class="group">
                        <label for="seva_amount">Seva Amount:</label>
                        <input type="text" id="seva_amount" name="seva_amount" value="<%=rst.getString(3)%>" readonly>
                    </div>
                    <div class="group">
                        <label for="seva_duration">Seva Timings</label>
                        <input type="text" id="seva_duration" name="seva_time" value="<%=rst.getString(4)%>" required>
                    </div>
