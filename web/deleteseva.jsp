<%-- 
    Document   : deleteseva
    Created on : Jul 3, 2023, 5:59:08 PM
    Author     : likir
--%>
...
<html>
    ...
    <body>
        ...
        <div class="head">
            <table>
                <tr><td><h3>Delete Sevas</h3></td></tr>
            </table>
        </div>

        <div class="delseva">
            <h2><u>Delete Seva</u></h2>
            <form action="deletesevacheck.jsp" method="post">
                <div class="group">
                    <label for="seva_name">Select the Seva to be deleted:</label>
