<%-- 
    Document   : editroom1
    Created on : Jul 16, 2023, 3:08:58 PM
    Author     : likir
--%>
    ...
    <body>
        ...
        <div class="addroom">
            ...
            <%
                ...
                rst = stmt.executeQuery("select * from roomdetails where roomno='" + roomno + "'");
                while (rst.next()) {
            %>
            <form action="editroomcheck.jsp" method="post">
                <div class="group">
                ...
                <div class="group">
                    ...
                    <input type="text" id="description" value="<%=rst.getString(2)%>" name="description" required>
                </div>
                <div class="group">
                    <label for="prize">Prize:</label>
                    <input type="number" id="prize" value="<%=rst.getString(3)%>" name="prize" required>
                </div>
