<%-- 
    Document   : userdonation
    Created on : Jul 4, 2023, 8:39:36 PM
    Author     : likir
--%>
...
<html>
    ...
    <body onload="generateRandomNumber()">
        ...
        <div>
            <div class="head">
                <table>
                    <tr><td><h3>E-hundi</h3></td></tr>
                </table>
            </div>           
        </div>
        <div class="container">
            <h1>Donate</h1>
            <form action="donationcheck.jsp" method="POST">
                <div class="form-group">
                    <label for="name">Donor Name:</label>
                    <input type="text" id="name" name="name" pattern="[A-Za-z]{1,} { }" required=""  title="Please enter only characters" placeholder="Enter donor name" required>
                </div>
                <div class="form-group">
                    <label for="amount">Amount:</label>
                    <input type="number" id="amount" name="amount" step="0.01" min="0" placeholder="Enter donation amount" required>
                </div>
                <div class="form-group">
                    <label for="datetime">Date and Time:</label>
                    <input type="datetime" id="datetime" name="datetime" readonly>
                </div>
                <div class="form-group">
                    <label for="mobile">Mobile Number:</label>
                    <input type="text" id="mobile" name="mobile" pattern="[6789][0-9]{9}" title="Please enter a valid phone number.. Number should begin with 6,7,8,9" placeholder="Enter your mobile number" required>
                </div>
                <div class="form-group">
                ...
                <input type="hidden" name="transactionId" id="randomNumber">
