<%-- 
    Document   : userhome
    Created on : Jul 3, 2023, 9:57:58 PM
    Author     : likir
--%>
...
<html>
    ...
    <body>
        ...
        <div>
            ...
            <div class="head">
                <table>
                    <tr><td><h3>Welcome <%=rst.getString("name")%></h3></td></tr>
                </table>
            </div> 
            <%
                }
        ...
        <div class="resimg">
            <h2 id="soul">Embracing the Divine, Illuminating the Soul!</h2><!--
            ...
            <div class="responsive">
                <div class="gallery">
                    <a target="_blank" href="img_5terre.jpg">
                        <img src="images/anna3.jpg" alt="Cinque Terre" width="600" height="400">
                    </a>
                    <div class="desc">Anna dhana</div>
                </div>
            </div>
            ...
            <div class="responsive">
                <div class="gallery">
                    <a target="_blank" href="img_forest.jpg">
                        <img src="images/ratha.jpg" alt="Forest" width="600" height="400">
                    </a>
                    <div class="desc">Rathotsava</div>
                </div>
            </div>
            ...
            <div class="responsive">
                <div class="gallery">
                    <a target="_blank" href="img_lights.jpg">
                        <img src="images/temproom.jpg" alt="Northern Lights" width="600" height="400">
                    </a>
                    <div class="desc">Temple rooms</div>
                </div>
            </div>
            ...
            <div class="responsive">
                <div class="gallery">
                    <a target="_blank" href="img_mountains.jpg">
                        <img src="images/edonation.jpg" alt="Mountains" width="600" height="400">
                    </a>
                    <div class="desc">E-hundi</div>
                </div>
            </div>
            ...
            <div style="padding:6px;">
                <p id="para">We extend a warm and heartfelt welcome to all devotees visiting our sacred online space. It is our honor to have you here, and we hope that your virtual journey through our website will bring you closer to the divine.

At our temple, we strive to create an environment of spirituality, peace, and harmony, and this website serves as an extension of that vision. Here, you will find a wealth of information about our temple, its history, traditions, and the various spiritual activities we undertake. We have designed this website with utmost care to provide you with a comprehensive experience that mirrors the tranquility and sanctity of our physical temple.</p>
            </div>
        </div>
        <div class="short">
            <button onclick="mybook();" class="btn"><i class="fas fa-calendar-check"></i> My bookings</button>
            <button onclick="updateprofile();" class="btn"><i class="fas fa-user-cog"></i>Update Profile</button>
        </div>
    </body>
</html>
